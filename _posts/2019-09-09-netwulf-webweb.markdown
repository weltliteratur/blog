...
**DraCor** is the Drama Corpora platform at dracor.org which holds a growing number of collections of plays of different languages, countries and times (German, Russian, Spanish, Swedish, Roman, Greek, with more to come).

Recently, [Twitter](https://twitter.com/DanLarremore/status/1161003051726958592) pointed us to the Python packages **webweb** and **netwulf**:
...
Let's first creat a universal function (netwulf_representation in the Jupyter Notebook)

Then we can retrieve the titles of all plays in a corpus (retrieve_all_plays):
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/godunov1.png" alt="Boris Godunov (1)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/godunov2.png" alt="Boris Godunov (2)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/godunov3.png" alt="Boris Godunov (3)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/godunov4.png" alt="Boris Godunov (4)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/galotti1.png" alt="Emilia Galotti (1)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/galotti2.png" alt="Emilia Galotti (2)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/galotti3.png" alt="Emilia Galotti (3)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/galotti4.png" alt="Emilia Galotti (4)" style="width:300px;" />
</figure>
...
We wrote a universal function to integrate DraCor data with webweb ("webweb_representation", cf. [our Jupyter Notebook](https://github.com/ldsad7/netwulf_and_webweb_for_rusdracor)).
...
Let’s look at the graphs produced by WebWeb:
...
```
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/webweb1.png" alt="webweb (1)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/webweb2.png" alt="webweb (2)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/webweb3.png" alt="webweb (3)" style="width:300px;" />
</figure>
...
<figure style="text-align:left;">
  <img src="/images/netwulf-webweb/webweb4.png" alt="webweb (4)" style="width:300px;" />
</figure>
